...
public class CharacterPickerWindow extends PopupWindow implements View.OnClickListener {
    ...
    public CharacterPickerWindow(Context context, int tag) {
        super(context);
        this.tag = tag;
        ...
        pickerView.wheelOptions.setTag(tag);
    ...
    public void onClick(View v) {
        ...
        if (!tag.equals(TAG_CANCEL)) {
            if (optionsSelectListener != null) {
                ...
                optionsSelectListener.onOptionChanged(this.tag, optionsCurrentItems[0], optionsCurrentItems[1], optionsCurrentItems[2]);
            }
        }
        dismiss();
    }
