...
final class WheelOptions {
    ...
    public WheelOptions(CharacterPickerView view, int tag) {
        super();
        this.view = view;
        this.tag = tag;
    }
    ...
    public void setPicker(List<String> options1Items,
        ...
        // 选项1
        wv_option1 = view.findViewById(R.id.j_options1);
        ...
        // 选项2
        wv_option2 = view.findViewById(R.id.j_options2);
        if (!mOptions2Items.isEmpty()) {
        ...
        // 选项3
        wv_option3 = view.findViewById(R.id.j_options3);
        if (!mOptions3Items.isEmpty()) {
    ...
    private void doItemChange() {
        if (mOnOptionChangedListener != null) {
            ...
            mOnOptionChangedListener.onOptionChanged(tag, option1, option2, option3);
        }
    }
